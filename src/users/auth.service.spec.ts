...
describe('AuthService', () => {
  ...
  it('throws an error if user signs with email in use', async () => {
  ...
  it('throws error if user signins with unused email', async () => {
    expect(service.signin('asdf@fsf.com', 'asdf')).rejects.toBeInstanceOf(
      NotFoundException,
    );
  });
  ...
  it('throws error if invalid password is provided', async () => {
    ...
    await expect(
      service.signin('asdf@asdf.com', 'asdfdf'),
    ).rejects.toBeInstanceOf(BadRequestException);
  });
